...
As I built this site I wanted an Atom or RSS feed that was optimized for Feedly. Feedly is an incredibly popular content aggregator and it made sense to optimize my feed for it. I didn't want to spend a lot of time or effort, but in a few minutes, I covered the basics giving me some nice customizations.
